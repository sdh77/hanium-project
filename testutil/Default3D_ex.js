...
const tgaTexture = [
  "data/default/KumDori_Main_Body_MAT_Base_color.TGA",
  "data/default/KumDori_Main_Head_MAT_Base_color.TGA",
];
class App {
  constructor() {
  ...
  _setupModel() {
    ...
    loader.load("data/default/KumDori_Base_High.FBX", (object) => {
