...
const tgaTexture = [
  "JS/data/king/KumDori_Main_Body_MAT_Base_color.TGA",
  "JS/data/king/KumDori_Main_Head_MAT_Base_color.TGA",
  "JS/data/king/KumDori_King_Hanbok_MAT_Base_color.TGA",
  "JS/data/king/KumDori_King_Hanbok_hat_MAT_Base_color.TGA",
];
class App {
  constructor() {
  ...
  _setupModel() {
    ...
    loader.load("JS/data/king/Kumdori_Hanbok_King_High.FBX", (object) => {
